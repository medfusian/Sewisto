...
(function ($) {	
      ...
      Drupal.behaviors.qtyBtn = {
        attach: function(context, settings) {                
          ...
          $(".quantity-minus", context).click(function () {
            if ($(this).next(".form-text").val() > 1) {
              $(this).next(".form-text").val(+$(this).next(".form-text").val() - 1);
            }
            return false;
          });
          $(".quantity-plus", context).click(function () {
            $(this).prev(".form-text").val(+$(this).prev(".form-text").val() + 1);
            return false;
          });
        }
      };  
      ...
      $(".field-name-field-customer-phone input").mask("+375 (99) 999-99-99");
